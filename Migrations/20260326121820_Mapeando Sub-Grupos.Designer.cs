...
namespace TakeANumber.Migrations
{
    ...
    [Migration("20260326121820_Mapeando Sub-Grupos")]
    partial class MapeandoSubGrupos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TakeANumber.Models.TicketGroup", b =>
                {
                    ...
                    b.Property<int?>("ComapanyChildrenId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TakeANumber.Models.TicketGroup", b =>
                {
                    b.HasOne("TakeANumber.Models.TicketGroup", "TicketGroupChildren")
                        .WithMany()
                        .HasForeignKey("ComapanyChildrenId")
                        .HasConstraintName("FK_CompanyCompany_CompanyChildrenId");

                    b.Navigation("TicketGroupChildren");
                });
